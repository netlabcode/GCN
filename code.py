...
def PrepareDataset(speed_matrix, BATCH_SIZE=40, seq_len=10, pred_len=1, train_propotion=0.7, valid_propotion=0.2):
    ...
    return train_dataset, valid_dataset, test_dataset, max_speed
...
A = np.load('Loop_Seattle_2015_A.npy')
FFR_5min = np.load('Loop_Seattle_2015_reachability_free_flow_5min.npy')
FFR_10min = np.load('Loop_Seattle_2015_reachability_free_flow_10min.npy')
FFR_15min = np.load('Loop_Seattle_2015_reachability_free_flow_15min.npy')
FFR_20min = np.load('Loop_Seattle_2015_reachability_free_flow_20min.npy')
FFR_25min = np.load('Loop_Seattle_2015_reachability_free_flow_25min.npy')
FFR = [FFR_5min, FFR_10min, FFR_15min, FFR_20min, FFR_25min]

"""
#To CSV
np.savetxt("adjecency.csv", A, delimiter=",")
np.savetxt("FFR_5min.csv", FFR_5min, delimiter=",")
np.savetxt("FFR_10min.csv", FFR_10min, delimiter=",")
np.savetxt("FFR_15min.csv", FFR_15min, delimiter=",")
np.savetxt("FFR_20min.csv", FFR_20min, delimiter=",")
np.savetxt("FFR_25min.csv", FFR_25min, delimiter=",")
"""
